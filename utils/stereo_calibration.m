...
addpath(strcat(pwd,'/data'));
addpath(strcat(pwd,'/calibration'));
rgb=load('calibration/panasonicRGBcameraParams.mat');
tof=load('calibration/panasonicIRcameraParams.mat');
...
translationOfCamera2 = ...
    [ -3.7419189660694208e+01, -8.3045818748568878e-01, 5.9651301067425795e+00 ];
stereoParams = stereoParameters(rgb.rgbCameraParams, tof.irCameraParams, ...
    rotationOfCamera2, translationOfCamera2);
save('calibration/panasonicStereoParams.mat', 'stereoParams');