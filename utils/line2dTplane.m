...
%% Input Arguments:
% - line_model: line in 2D 
%               (a, b, c) st. a*col + b*row + c = 0
% - C: Intrinsic matrix of tof camera
%
%% Ouput Argument:
% - plane_model:the plane in 3D, points of which all projects to 
%               the input line in the camera's image
%               b is a 4x1 array of plane coefficients in the form
