...
def calibrate(square_size, width=7, height=5, prefix='GrayImage_',
    ...
    for fname in images:
        img = cv2.imread(fname, 0)  # Using 0 to read image in grayscale mode
        gray = img
...
if __name__ == '__main__':
    ...
    ret, mtx, dist, rvecs, tvecs = calibrate(square_size=0.0131923, width=13, height=6,
                                             dirpath='../data/calibration0618/')
